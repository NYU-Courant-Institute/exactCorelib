...
public:
  ...
  BigFloat2 evalApprox(const BigFloat& f, long r=defRelPrec) const;
  ...
  BigFloat evalExactSign(const BigFloat& val, long oldMSB=54) const;
  ...
  BigFloat CauchyBound() const;  // Cauchy Root Bound
