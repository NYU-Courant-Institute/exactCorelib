...
//       and estimating of the range of the recursive Hermite interpolants h_j with the centered form
//
//////////////////////////////////////////////////////////////////

#ifndef __CORE_EVALH4CHEAP_H__
#define __CORE_EVALH4CHEAP_H__

#include "evalHermite.h"
#include "exactRange.h"

class evalH4cheap : public evalHermite {
public:
  ...
  // CONSTRUCTORS
  //
  evalH4cheap(vector<real> v, interval I): evalHermite(v,I) { name = "evalH'4"; }
  evalH4cheap(): evalHermite() { name = "evalH'4"; }
  ...
  //
    ...
    //
    // where T'_{4,n} = \sum_{j=1}^{d/4} |[]h_j(I)| \Omega_4^j
    // and the range of h_j is estimated with the centered form evaluation
    //
    // compute T'_{4,n} using Horner summation
    //
