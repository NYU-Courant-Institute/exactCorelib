...
#= 
    ...
    A constructor for myBox.

    # Arguments
    - `x::myInterval`: The x interval of the box
    - `y::myInterval`: The y interval of the box
    - `depth::Int=0`: The depth of the box (default: 0)

    # Returns
    - `myBox`: A myBox object with the specified intervals and depth

    # Description
    This constructor initializes a myBox object with the given x and y intervals and depth. It also computes the necessary box parameters such as the midpoints, radii, and a matrix of box points.
=#
...
#=
    ...
    Assigns the internal neighbors of the given children boxes.

    # Arguments
    - `children::Vector{myBox}`: A vector of four myBox objects representing the children boxes

    # Description
    This function assigns the internal neighbors of the given children boxes. It assumes that the children boxes are ordered as [bottom-left, top-left, bottom-right, top-right]. The function establishes the up, down, left, and right relationships between the boxes based on their positions in the grid.
=#
...
#=
    ...
    Assigns the external neighbors of the given parent box to its children boxes.

    # Arguments
    - `parent::myBox`: The parent box
    - `children::Vector{myBox}`: A vector of four myBox objects representing the children boxes

    # Description
    This function assigns the external neighbors of the given parent box to its children boxes. It assumes that the children boxes are ordered as [bottom-left, top-left, bottom-right, top-right]. The function establishes the up and down relationships between the parent and its children boxes based on their positions in the grid.
=#
...
#=
    ...
    Determines if the y-intervals of two boxes overlap.

    # Arguments
    - `b::myBox`: The first box
    - `c::myBox`: The second box
...
#=
    ...
    Determines if the x-intervals of two boxes overlap.
