...
int main(int argc, char **argv)
{
  ...
  display_funcs::PROG_PARAMS.x_min = x_minimum.getValue();
  display_funcs::PROG_PARAMS.x_max = x_maximum.getValue();
  display_funcs::PROG_PARAMS.y_min = y_minimum.getValue();
  display_funcs::PROG_PARAMS.y_max = y_maximum.getValue();
  ...
  display_funcs::PROG_PARAMS.b0=box;
