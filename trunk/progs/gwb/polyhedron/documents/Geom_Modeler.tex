...
\begin{figure}[h!]
        ...
        \begin{subfigure}[b]{0.2\textwidth}
                \centering
                \includegraphics[width=0.5\textwidth,natwidth=600,natheight=10]{emptybox.pdf}
                \caption{Empty box}
                \label{fig:empty}
        \end{subfigure}%
        ...
        \begin{subfigure}[b]{0.2\textwidth}
                \centering
                \includegraphics[width=0.5\textwidth,natwidth=600,natheight=10]{fullbox.pdf}
                \caption{Full box}
                \label{fig:full}
        \end{subfigure}
        ~ %add desired spacing between images, e. g. ~, \quad, \qquad etc. 
        ...
        \begin{subfigure}[b]{0.2\textwidth}
                \centering
                \includegraphics[width=0.5\textwidth,natwidth=600,natheight=10]{facebox.pdf}
                \caption{Face box}
                \label{fig:face}
        \end{subfigure}
        \begin{subfigure}[b]{0.2\textwidth}
                \centering
                \includegraphics[width=0.5\textwidth,natwidth=600,natheight=10]{edgebox.pdf}
                \caption{Edge box}
                \label{fig:edge}
        \end{subfigure}%
        \begin{subfigure}[b]{0.2\textwidth}
                \centering
                \includegraphics[width=0.5\textwidth,natwidth=600,natheight=10]{vertbox.pdf}
                \caption{Vertex box}
                \label{fig:vert}
        \end{subfigure}%
        \caption{Elementary boxes}\label{fig:elementary}
\end{figure}
%------------elementary boxes---------------------
...
\\
\\
\indent We define $d(x,y)$ to be Euclidean distance between $x$ and $y$ ($x,y$ can be vertex, edge or face). Given a non-elementary subbox $B^\prime$ having features $\Phi\ (B^\prime, P)$ for $P$, we discuss the following 6 simplest cases:
\\
\\
...
Suppose $n_1$, $n_2$ are two corresponding elementary leaf nodes of $T_1$, $T_2$ for $P_1$, $P_2$ respectively. Each of them represents one of the five types: empty box (EMB), full box (FUB), vertex box (VB), edge box (EDB), face box (FAB). We have the following rules (left operand is of $n_1$, right operand is of $n_2$):
...
\item $VB_1 \cup VB_2$
\\
If $VB_1$ and $VB_2$ share the same vertex, the result is a vertex box. Otherwise the result is a non-elementary box which needs further subdivision.
