...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "C:/Users/zhaoq/Desktop/Cygwin/bin/git.exe" rev-parse "${ref}^0"
...
execute_process(
  COMMAND "C:/Users/zhaoq/Desktop/Cygwin/bin/git.exe" show-ref "3327050ca66ad34426a82c217c2d60ced61526b7"
  WORKING_DIRECTORY "C:/Users/zhaoq/Desktop/Study/GitHub/6DOF_Robot/build/_deps/glfw-src"
...
if(fetch_required)
  ...
  execute_process(
    COMMAND "C:/Users/zhaoq/Desktop/Cygwin/bin/git.exe" fetch --tags --force "origin"
    WORKING_DIRECTORY "C:/Users/zhaoq/Desktop/Study/GitHub/6DOF_Robot/build/_deps/glfw-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "C:/Users/zhaoq/Desktop/Cygwin/bin/git.exe" symbolic-ref -q HEAD
    WORKING_DIRECTORY "C:/Users/zhaoq/Desktop/Study/GitHub/6DOF_Robot/build/_deps/glfw-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "C:/Users/zhaoq/Desktop/Cygwin/bin/git.exe" for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "C:/Users/zhaoq/Desktop/Study/GitHub/6DOF_Robot/build/_deps/glfw-src"
...
execute_process(
  COMMAND "C:/Users/zhaoq/Desktop/Cygwin/bin/git.exe" status --porcelain
  WORKING_DIRECTORY "C:/Users/zhaoq/Desktop/Study/GitHub/6DOF_Robot/build/_deps/glfw-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "C:/Users/zhaoq/Desktop/Cygwin/bin/git.exe" stash save --quiet;--include-untracked
    WORKING_DIRECTORY "C:/Users/zhaoq/Desktop/Study/GitHub/6DOF_Robot/build/_deps/glfw-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "C:/Users/zhaoq/Desktop/Cygwin/bin/git.exe" checkout "${checkout_name}"
    WORKING_DIRECTORY "C:/Users/zhaoq/Desktop/Study/GitHub/6DOF_Robot/build/_deps/glfw-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "C:/Users/zhaoq/Desktop/Cygwin/bin/git.exe" rebase "${checkout_name}"
    WORKING_DIRECTORY "C:/Users/zhaoq/Desktop/Study/GitHub/6DOF_Robot/build/_deps/glfw-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "C:/Users/zhaoq/Desktop/Cygwin/bin/git.exe" rebase --abort
      WORKING_DIRECTORY "C:/Users/zhaoq/Desktop/Study/GitHub/6DOF_Robot/build/_deps/glfw-src"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "C:/Users/zhaoq/Desktop/Cygwin/bin/git.exe" stash pop --index --quiet
          WORKING_DIRECTORY "C:/Users/zhaoq/Desktop/Study/GitHub/6DOF_Robot/build/_deps/glfw-src"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/zhaoq/Desktop/Study/GitHub/6DOF_Robot/build/_deps/glfw-src'."
    ...
    execute_process(
      COMMAND "C:/Users/zhaoq/Desktop/Cygwin/bin/git.exe" tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "C:/Users/zhaoq/Desktop/Cygwin/bin/git.exe" reset --hard --quiet
      WORKING_DIRECTORY "C:/Users/zhaoq/Desktop/Study/GitHub/6DOF_Robot/build/_deps/glfw-src"
    )
    execute_process(
      COMMAND "C:/Users/zhaoq/Desktop/Cygwin/bin/git.exe" stash pop --quiet
      WORKING_DIRECTORY "C:/Users/zhaoq/Desktop/Study/GitHub/6DOF_Robot/build/_deps/glfw-src"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "C:/Users/zhaoq/Desktop/Cygwin/bin/git.exe" reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "C:/Users/zhaoq/Desktop/Study/GitHub/6DOF_Robot/build/_deps/glfw-src"
      )
      execute_process(
        COMMAND "C:/Users/zhaoq/Desktop/Cygwin/bin/git.exe" stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/zhaoq/Desktop/Study/GitHub/6DOF_Robot/build/_deps/glfw-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
...
if(init_submodules)
  execute_process(
    COMMAND "C:/Users/zhaoq/Desktop/Cygwin/bin/git.exe" submodule update --recursive --init 
    WORKING_DIRECTORY "C:/Users/zhaoq/Desktop/Study/GitHub/6DOF_Robot/build/_deps/glfw-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
