 ...
 *
 * $Id: triangle3d.h,v 1.1 2006/04/03 20:05:18 exact Exp $
 *****************************************************************/
...
class Triangle3d : public GeomObj {
 ...
 public:
  ...
  Point3d nearPoint(const Point3d& p) const;
  ...
  **/
  ...
  Polygon3d* in_half_plane(const Point3d& pa, const Point3d& pb,
                           const Point3d& pSide, Polygon3d& plg) const;
