/*****************************************************************
 ...
 purpose:
	...
	implementation of Graham's convex hull algorithm.
        ...
        -- input points are 2D points 

 Usage:
        % graham [-l] < input_file >! output_file
	...
	The maximum number of points is 3000 (this is easily changed).

 Author:
        Hui Jin (hj228@cs.nyu.edu), August 1999

	CORE Library: $Id: graham.cpp,v 1.1 2006-03-07 04:51:23 exact Exp $
