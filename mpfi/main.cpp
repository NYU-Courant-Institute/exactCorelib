...
int main()
{
    ...
    interval<double> my_double_interval = 10;
    double my_double,my_double_width,my_double_upper, my_double_lower,my_double_upper_unrounded, my_double_lower_unrounded,my_unrounded_width;
    
    // Create an Boost MPFI interval (10,10) using 50 digits of precision and a few MPFR values
    mpfi_float_50 my_second_small_interval,my_small_interval = 10;
    mpfr_float_50 my_small_number,my_small_width,my_small_number_upper, my_small_number_lower;
    
    // Create an Boost MPFI interval (10,10) using 1000 digits of precision and a few MPFR values
    mpfi_float_1000 my_second_large_interval,my_large_interval = 10;
    mpfr_float_1000 my_large_number,my_large_width,my_large_number_upper, my_large_number_lower;
