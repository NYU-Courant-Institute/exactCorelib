/* **************************************
   ...
   $Id: tt.cpp,v 1.1 2006-03-07 04:51:23 exact Exp $
 ************************************** */
...
int main(int argc, char* argv[])
{
	...
	switch (curveNo1){
	  case 0:
	    ...
	    vP1.push_back( Polynomial<NT>::polyZero() );	// coeff of y
	  ...
	  case 2:
	    ...
	    vP1.push_back( Polynomial<NT>::polyZero() );	// coeff of y^2
	...
	switch (curveNo2){
	    ...
	    vP2.push_back( Polynomial<NT>::polyZero() );	// coeff of y
	  ...
	  case 2:
	    ...
	    vP2.push_back( Polynomial<NT>::polyZero() );	// coeff of y^2
...
/*
	...
	vP3.push_back( Polynomial<NT>::polyZero() );	// coeff of y
